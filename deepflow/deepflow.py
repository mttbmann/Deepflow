        ...
        if file_format == '.pdb' or file_format == '.xyz':
            ...
            if not os.path.exists(project_path):
                ...
                for subdir in ["cp2k_equilibration", "cp2k_production", "dpgen_data_conversion",
                               "dpgen_active_learning", "lammps_test_run", "lammps_calculate_rate_constants","deepmd_train_model"]:
...
Usage:
  ...
  deepflow load <project_path>
    ...
    """
    parser = argparse.ArgumentParser(description="Deepflow management tool",epilog=workflow_classes_desc, formatter_class=argparse.RawTextHelpFormatter)
